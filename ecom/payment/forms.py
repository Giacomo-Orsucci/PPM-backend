...
class ShippingForm(forms.ModelForm):
    ...
    shipping_state =  forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'State (or region)'}), required=False)
...
class PaymentForm(forms.Form):
    ...
    card_country = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Billing country (or region)'}), required=False)